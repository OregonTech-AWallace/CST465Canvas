...
1. Given the following code, which of the following statement is true about the first web request to the application?
`Program.cs`
```csharp
builder.Services.AddTransient<>();
builder.Services.AddSoped<>();
builder.Services.AddSingleton<>();
```
``

1. Given the following code, which of the following statement is true about the second web request to the application?
`Program.cs`
```csharp
